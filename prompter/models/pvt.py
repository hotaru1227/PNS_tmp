...
if __name__ == '__main__':
    ...
    input_image_path = "/data/hotaru/projects/PNS_tmp/segmentor/datasets/cpm17/train/Images/image_00.png"
    ...
    save_tensor_as_image(x1_map, "/data/hotaru/projects/PNS_tmp/prompter/checkpoint/cpm17/prediction1.png")
    x2_map = torch.mean(x2, dim=1, keepdim=True)
    save_tensor_as_image(x2_map, "/data/hotaru/projects/PNS_tmp/prompter/checkpoint/cpm17/prediction2.png")
    x3_map = torch.mean(x3, dim=1, keepdim=True)
    save_tensor_as_image(x3_map, "/data/hotaru/projects/PNS_tmp/prompter/checkpoint/cpm17/prediction3.png")
    x4_map = torch.mean(x4, dim=1, keepdim=True)
    save_tensor_as_image(x4_map, "/data/hotaru/projects/PNS_tmp/prompter/checkpoint/cpm17/prediction4.png")
